# Scenario 3: Fixtures and `mcp_server`

> **Goal:** Built-in fixtures, dependency order, and custom fixtures in Python tests.

| Field | |
| --- | --- |
| **Primary example** | [`../../example_fixture_system.md`](../../example_fixture_system.md) — *Fixture system* |
