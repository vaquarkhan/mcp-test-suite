# Scenario 6: Parallel workers

> **Goal:** Run test files across workers; same-file tests stay on one worker.

| Field | |
| --- | --- |
| **Primary example** | [`../../example_parallel_workers.md`](../../example_parallel_workers.md) — *Parallel execution* |
