# Scenario 8: Markers, skip, and retries

> **Goal:** Timeouts, retries, skip reasons, and tags for CI filtering.

| Field | |
| --- | --- |
| **Primary example** | [`../../example_markers_skip.md`](../../example_markers_skip.md) — *Markers / skip* |
