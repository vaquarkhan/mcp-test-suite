...
> **Goal:** Machine-readable results for custom dashboards and tooling.

| Field | |
| --- | --- |
| **Primary example** | [`../../mcp_test_report_json.yaml`](../../mcp_test_report_json.yaml) — *Sample `mcp-test.yaml`* |
