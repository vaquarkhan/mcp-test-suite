# Scenario 12: Plugins (assertions, fixtures, reporters)

> **Goal:** Load custom behavior through `mcp-test.yaml` and small Python modules.

| Field | |
| --- | --- |
| **Primary example** | [`../../reference_plugin.py`](../../reference_plugin.py) — *Reference plugin* |
