# Scenario 13: Stdio transport

> **Goal:** The default: launch a subprocess and talk MCP over stdio.

| Field | |
| --- | --- |
| **Primary example** | [`../../sample_mcp_test.yaml`](../../sample_mcp_test.yaml) — *Full sample config* |
