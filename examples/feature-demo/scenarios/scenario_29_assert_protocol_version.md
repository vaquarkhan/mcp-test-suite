# Scenario 29: `assert_protocol_version`

> **Goal:** Pin expected MCP protocol versions after upgrades.

| Field | |
| --- | --- |
| **Primary example** | [`../../example_mcp_assertions.md`](../../example_mcp_assertions.md) — *Protocol* |
