# mcp-test-harness-deepseek

DeepSeek AI testing helpers for [MCP Test Harness](https://github.com/vaquarkhan/mcp-test-harness).
...
```bash
pip install mcp-test-harness-deepseek
```
